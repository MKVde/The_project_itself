...
# GitHub credentials
github_repository_name = "Name_repository"
github_username = "your_username"
token = "Your_github_token"

# Email credentials
my_email_address = "Your_email"
email_password = "your_email_password"
received_email_address = "received_email_address"
...
response = openai.Completion.create(
    engine= engine_model,
    prompt=("- Generate a README file for this script : \n - inculuding in formation like Getting Started, Usage, How it work, Getting Started, Documentation and License.\n - Here is the Script:\n"
        f"{script_contents}"
    ),
    max_tokens=2048,
    n=1,
...
# Send the email
with smtplib.SMTP("smtp.office365.com", 587) as server: # The SMPT sever you will use to send the message  
        server.ehlo()
        server.starttls()
